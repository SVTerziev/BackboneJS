	...
	var Tooltip = function () {
	  ...
	  _createClass(Tooltip, [{
	    ...
	    value: function position(reference) {
          ...
          if (parseInt(containerBounds.bottom - rootBounds.bottom) < 100) {
            var verticalShift = containerBounds.bottom - rootBounds.bottom - this.root.offsetHeight;
      
            this.root.style.top = (top - 50) + 'px';
	      }
	      this.checkBounds();
